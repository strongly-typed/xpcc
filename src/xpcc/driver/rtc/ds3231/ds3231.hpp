...
/**
 * DS3231: Proximity and ambient light sensing (ALS) module
 *
...
class Ds3231 : public ds3231, public xpcc::I2cDevice< I2cMaster, 2 >
{
public:
	/// Constructor, requires an vl6180::Data object, sets address to default of 0x29
	Ds3231(Data &data, uint8_t address=0x68);
...
#include "ds3231_impl.hpp"

#endif // XPCC_DS3231_HPP
